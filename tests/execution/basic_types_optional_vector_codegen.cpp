...
template <> openspace::documentation::Documentation doc<openspace::BasicTypesOptionalVector>() {
...
,Optional::Yes,"dmat4x4 value documentation"});
    ...
    openspace::documentation::Documentation d = { "BasicTypesOptionalVector", "BasicTypesOptionalVector", std::move(codegen_Parameters->documentations) };
...
template <> Parameters bake<Parameters>(const ghoul::Dictionary& dict) {
    openspace::documentation::testSpecificationAndThrow(codegen::doc<openspace::BasicTypesOptionalVector>(), dict, "BasicTypesOptionalVector");
    Parameters res;
