...
template <> openspace::documentation::Documentation doc<openspace::BasicTypesOptional>() {
    ...
    openspace::documentation::Documentation d = { "BasicTypesOptional", "BasicTypesOptional", std::move(codegen_Parameters->documentations) };
...
template <> Parameters bake<Parameters>(const ghoul::Dictionary& dict) {
    openspace::documentation::testSpecificationAndThrow(codegen::doc<openspace::BasicTypesOptional>(), dict, "BasicTypesOptional");
    Parameters res;
